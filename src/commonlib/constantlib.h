...
namespace PROJECT_NAME{
    ...
    struct basic_array{
        ...
        constexpr basic_array(const array_base<T,size>& in):base(in){}
        constexpr basic_array(array_base<T,size>&& in):base(in){}
        constexpr T& operator[](size_t pos){return base[pos];}
        constexpr T* begin(){return base.begin();}
        constexpr T* end(){return base.end();}
        constexpr const T* cbegin(){return base.cbegin();}
        constexpr const T* cend(){return base.cend();}
        constexpr operator array_base<T,size>&(){return base;}
    };
