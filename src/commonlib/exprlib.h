...
namespace PROJECT_NAME{
    struct CharObject{
        ...
        constexpr CharObject(CharObject&& in):c(in.c){}
    ...
    struct OrObject{
        ...
        constexpr OrObject(T&& t,U&& u):t(std::forward<T>(t)),u(std::forward<U>(u)){}
    ...
    struct RepeatObject{
        Obj o;
        constexpr RepeatObject(Obj&& in):o(std::forward<Obj>(in)){}
    ...
    struct AndObject{
        ...
        constexpr AndObject(T&& t,U&& u):t(std::forward<T>(t)),u(std::forward<U>(u)){}
