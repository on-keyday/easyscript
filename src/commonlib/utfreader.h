...
#define DEFINE_UTF_TEMPLATE(NAME,SIZE,INCR,DECR,MINBUF)\
    ...
    DEFINE_UTF_TEMPLATE
    (ToUTF8,4,(utf32toutf8<Buf,U8MiniBuffer>),([](Reader<Buf>*r){return r->decrement();}),U8MiniBuffer);

    DEFINE_UTF_TEMPLATE
    (ToUTF8,2,(utf16toutf8<Buf,U8MiniBuffer>),([](Reader<Buf>* r){return utf16seek_minus<Buf>(r);}),U8MiniBuffer);
    ...
    DEFINE_UTF_TEMPLATE
    (ToUTF16,4,(utf32toutf16<Buf,U16MiniBuffer>),([](Reader<Buf>*r){return r->decrement();}),U16MiniBuffer);
