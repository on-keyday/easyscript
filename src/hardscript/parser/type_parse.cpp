...
std::string control::parse_type(ReaderT& reader,bool strict){
    std::string name;
...
bool control::parse_funcarg(ReaderT& reader,std::vector<std::string>& arg,std::vector<std::string>& type,std::string& ret,std::string& opt,bool strict){
    size_t count=0;
    while(!reader.expect(")")){
        std::string argname;
...
bool control::parse_arg_need_type(ReaderT& reader,std::string& name,std::string& type){
...
bool control::parse_arg_need_name(ReaderT& reader,std::string& name,std::string& type){
    reader.readwhile(name,untilincondition,is_c_id_usable<char>);
